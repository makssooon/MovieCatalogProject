...
Добавления информации о фильме
 ...
 - Title фильма пользователь может вписать любой, главное чтобы поле не было 
	пустым.
 - С genre фильма такая же история как и с title.
 - Release date пользователю поможет выбрать date picker keyboard с двумя 
	...
	раньше 14.10.1888.
 - Поле Director также просто не должно быть пустым.
